...
plt_0:
; pushq	0x2001a2(%rip)  ; 6003f8 <exit@plt+0x200188>
	db 0xFF, 0x35, 0xA2, 0x01, 0x20, 0x00
; jmpq	*0x2001a4(%rip) ; 600400 <exit@plt+0x200190>
	db 0xFF, 0x25, 0xA4, 0x01, 0x20, 0x00
; nopl	0x0(%rax)
...
plt_printf:
; jmpq	*0x2001a2(%rip) ; 600408 <exit@plt+0x200198>
	db 0xFF, 0x25, 0xA2, 0x01, 0x20, 0x00

.resolve:
; pushq	$0x0
	db 0x68, 0x00, 0x00, 0x00, 0x00

; jmpq	400250 <printf@plt-0x10>
	db 0xE9, 0xE0, 0xFF, 0xFF, 0xFF

plt_exit:
; jmpq	*0x20019a(%rip) ; 600410 <exit@plt+0x2001a0>
	db 0xFF, 0x25, 0x9A, 0x01, 0x20, 0x00
